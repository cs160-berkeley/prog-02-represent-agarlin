...
//                        if (RepresentativeListActivity.send) {
                        System.out.println("n: " + RepresentativeListActivity.n);
//                        String message = bundle.getString("GO");

                        sendMessage("/GO", RepresentativeListActivity.n);
